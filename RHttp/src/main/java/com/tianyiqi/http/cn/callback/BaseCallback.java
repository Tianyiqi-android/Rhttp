package com.tianyiqi.http.cn.callback;

import com.tianyiqi.http.cn.RHttp;
import com.tianyiqi.http.cn.exception.ApiException;
import com.tianyiqi.http.cn.exception.ExceptionEngine;
import com.tianyiqi.http.cn.observer.HttpObserver;
import com.tianyiqi.http.cn.utils.ThreadUtils;
...
public abstract class BaseCallback<T> extends HttpObserver<T> {
    ...
    public void onNext(@NonNull T value) {
        super.onNext(value);
//        Log.i("返回数据BaseCallback", value.toString());
        inSuccess(value);
    }
